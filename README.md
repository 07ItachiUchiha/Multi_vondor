...
1. Clone the repository
   ```bash
   git clone https://github.com/yourusername/Multi_vendor_E_shop.git
...
5. Create a .env file in the backend/config directory with the following variables
   ```
   PORT=8000
   DB_URL=mongodb://localhost:27017/multi_vendor
